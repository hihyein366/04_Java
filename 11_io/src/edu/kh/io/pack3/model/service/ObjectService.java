...
public class ObjectService {
	 ...
	 * 
	 * - Java 객체(Instance == Object)를 입/출력 할 때 사용하는 바이트 기반 보조 스트림
	 * 	 (보조 스트림 단독 사용 불가능!)
	 * 
	 * *** 직렬화(Serializable) ***
	 * - 객체(Object)를 직렬 형태로 변환
	 */
	...
	public void objectOutput() {
		...
		try {
			...
			// Member 객체 하나 생성
			Member member = new Member("member01", "pass01!", "김준면", 34);
	...
	public void objectInput() {
		...
		try {
			...
			// ois.readObject() : 직렬화된 객체 읽어와 역직렬화 + Member 객체로 변경
