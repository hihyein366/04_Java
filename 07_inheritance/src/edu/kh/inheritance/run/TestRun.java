...
public class TestRun {
	...
	public static void main(String[] args) {
		...
		Parent p2 = new Parent("김", "수원시 영통구", 2000, "G80");
		...
		Child1 c2 = new Child1("5054 BH 그램");
		...
		Child2 c3 = new Child2("최", "서울시 강남구", 5555555, "벤츠", "아이폰15");
		...
		ch1.testMethod();
		ch2.testMethod();
		// 부모에 코드 추가/수정 하면 모든 자식한테도 코드가 업뎃된다
