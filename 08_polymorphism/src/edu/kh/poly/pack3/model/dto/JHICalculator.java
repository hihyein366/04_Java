...
// 각자 구현한 계산기
public class JHICalculator implements Calculator, Machine {
	...
	@Override
	public double div(int a, int b) { // b가 0인 경우 0.0 반환
	...
	public int sum(int... numbers) {
		...
		// 가변인자(...) : 전달 인자의 개수(전달 되는 값의 개수)가 변할 수 있는 매개 변수(전달 인자)
