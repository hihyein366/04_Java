...
public class ExceptionHandlingService3 {
	 ...
	 *  -> 예외 처리 구문(try-catch, throws)을 반드시 작성해야 되는 예외
	 * 
	 ...
	 * - 이미 만들어져 있는 Java 코드 이용 시 예외 처리가 꼭 필요한 경우(Checked)
	 */
	public void method2() {
		...
		// -> Scanner 보단 기능이 부족하지만 속도가 압도적으로 빠름
	 ...
	 */
	public void method4() {
		// inputString() 메서드를 이용해서 문자열을 두 번 입력 받아 하나로 합쳐 출력하기
		
		try {
			System.out.print("첫번째 문자열 : ");
			String s1 = inputString(); // inputString() 호출 -> throws IOException
	...
	public String inputString() throws IOException {
		...
		// 현재 메서드를 호출한 곳으로 던져서 상황에 맞게 별도 처리하게 함
	...
	public void method5() {
		...
		try {
			...
			if(result > 100) { // 절대 100점을 넘어서는 안돼..............!!!!!!!!!!!
