...
public class SetService {
	...
	public void method1() {
		...
		System.out.println(set); // set.toSting()'
		// -> HashSet 순서유지x
		...
		System.out.println("비어 있나? : " + set.isEmpty());
	...
	public void method2() {
		...
		// 다음 순차 접근할 요소 있으면 true, 없음 false
	...
	public void method3() {
		...
		Person p1 = new Person("김준면", 32, '남');
		Person p2 = new Person("김준면", 32, '남');
		Person p3 = new Person("김준면", 27, '남');
		Person p4 = new Person("정혜인", 24, '여');
		...
		// A.equals(B) : A와 B가 가지고 있는 필드 값이 같으면 true
		...
		for(Person p : personSet) {
			System.out.println(p); // 32세 김준면 한번만 나와야해
		}
	...
	/** 로또 번호 생성기
	 * 금액을 입력 받아(천원 단위)
	 * 1000원 당 1회 씩 번호 생성해서 List에 저장한 후
	 * 생성 종료 시 한 번에 출력
	 * 
	 * <pre>
	 * 금액 입력 : 3000
	 * 
	 * 1회 : [11,12,24,25,37,44]
	 * 2회 : [7,12,19,20,33,44]
	 * 3회 : [4,8,216,25,34,38]
	 * </pre>
	 */
	public void lottoNumGenerator() {
		...
		Random random = new Random(); // for문 돌 동안 객체 새로 만들 필요 없으니 이건 for문 밖에
...
//			System.out.println(lotto);
		...
		if (price < 1000) {
			System.out.println("1000원 이상을 입력해 주세요");
			return;
		}
