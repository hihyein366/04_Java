...
// 3) 객체만 저장 가능
//		(기본 자료형은 안됨, 하지만 Wrapper 클래스 이용하면 된다^^)
...
public class ListService {
	...
	public void method1() {
		...
		// E(Element) : 요소 뜻하는 상징적 글자. 자료형 가리지 않고 들어갈 수 있다. (Object, String, ..)
		//    반환형 메서드명(매개변수)
		...
		list.add(3.123123); // 크기 3 초과
		list.add(false);    // 초과 오류 나지 않음. cuz. 크기 자동으로 늘어나서
	...
	public void method2() {
		...
		// 컬렉션의 장점 중 "여러 타입 저장 가능"이 코드 길이 늘리는 주범!
		...
		// 3. void add(int index, E e) : index번째에 중간 삽입
		strList.add(1, "찜닭");
		
		// 4. String toString() : List에 저장된 모든 요소 문자열로 반환
		System.out.println(strList);
		// System.out.println(strList.toString());  // .toString() 안써도 됨
		
		
		// 5. E Set(int index, E e) :
		// index번째 요소를 e로 수정
		// -> 수정 전 요소가 반환됨
		String before = strList.set(2, "양념똥치킨");
	...
	public void bookManage() {
		...
		do {
			...
			case 3: 
				...
				if(index >= 0 && index < bookList.size()) { // 인덱스 범위 안 번호
