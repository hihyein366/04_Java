...
public class JavaAPIService {
	 ...
	 *  -> 기본 자료형의 객체화
	 *  
	 *  -> cuz. 컬렉션 처럼 객체만 취급하는 상황에서 기본 자료형도 취급 가능한 형태로 바꾸기 위해서
	 *  
	 *  				--> Boxing
	 * Unboxing <--
	 *   
	...
	public void method1() {
		int num1 = 100; // int
		// Integer wrap1 = new Integer(num1); // 삭제 예정인, 권장하지 않는 방법
	...
	public void method2() {
		...
		String change3 = test3 + ""; // long + String -> String + String -> 이어쓰기 됨
	...
	public void method3() {
		...
		// -> identityHashCode가 다 다른값이유..
		// --> str이 참조하고 있는 객체가 변하고 있기 때문
	 ...
	 *  -> 가변성(mutable)
	 * 
	 * - 기본 16글자 저장할 크기로 생성 저장되는 문자열의 길이에 따라 크기 증가/감소
	 *  -> 마음대로 문자열 수정, 삭제 가능!
	 *  -> 수정, 삭제 해도 추가적인 객체 생성이 없어 효율 굿
	 *  
	...
	public void method6() {
		...
		sb.append("무엇을 먹을까"); // "오늘 점심은 무엇을 먹을까"
		System.out.println(System.identityHashCode(sb));
		
		sb.insert(0, "2월 14일 "); // 0번 인덱스에 삽입 == 맨 앞에 추가
		System.out.println(System.identityHashCode(sb));
		
		// identityHashCode 값이 일정함
		// == 참조하는 객체 변하지 않음, 객체 내에 값만 수정된다
		// == 가변성
