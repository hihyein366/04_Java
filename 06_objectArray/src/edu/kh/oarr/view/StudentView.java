...
public class StudentView {
	...
	private void addStudent() {
		...
		if(result) {
			...
			System.out.println("학생을 더 이상 추가할 수 없어.. ㅇ ㅣ ㅇ ㅣ상은 안돼");
		}
	...
	private void selectScore() {
		...
		if(std == null) {
			System.out.println("해당 인덱스의 학생이 존재하지 않습니다");
			return;
		}
		
		// service.selectScore(인덱스) 호출 후 문자열로 반환받기
