...
public class StudentService {
	...
	// 학생 객체 참조 변수 10개 묶음인 Student[] 생성하고 그 주소 students 참조 변수에 대입
	...
	public StudentService() {
		...
		students[0] = new Student("24001", "고라니", 'F');
		students[1] = new Student("24002", "노라니", 'M');
		students[2] = new Student("24003", "도라니", 'F');
	...
	/** 전달 받은 학생 객체(주소)를 
	 * students 객체 배열에서 빈칸(null인 칸)에 대입
	 * 
	 * @param newStd : 전달 받은 학생
	 * 
	 * @return 대입 성공 시 true, 실패 시 false(꽉 차면 false)
	 */
	public boolean addStudent(Student newStd) {
		// students 배열의 인덱스 요소 중 맨 처음 null인 부분 찾아 newStd에 대입
	...
	public Student selectName(String name) {
		...
		// - 배열 || 컬렉션의 요소를 처음 부터 끝까지 순차 접근 하는 for문
		
		// - 매 반복마다 배열 || 컬렉션 요소를 하나씩 꺼내와 변수에 저장
